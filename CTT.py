...
"""
# TODO : we should consider a change, not a test case ?
...
# TODO : compared to a previous one. So we should add a new parameter.
...
# TODO : Should take into account last test case to know which pairs it will now cover.
...
# TODO : now should be every activation order.
